...
- Optimized remote checkpoint loading by delegating to `fs.get_file` on `local_rank == 0` with a version-keyed node-local cache and `mmap=True` in `_load` ([#21869](https://github.com/Lightning-AI/pytorch-lightning/pull/21869))
